...
We can conclude that there exist a significant difference between the two groups since the p-value is small enough under significance level of 5%.
...
Under significant level of 5%, the average house price is significantly different among different garage sizes.
...
The average house price is different between the garage size of 0 and garage size of 2, as the table below indicates.
...
The boxplot shows that an outlier price exists in the garage size of 0, and value of the outlier (388) is larger than the maximum value (339.9) in the garage size of 3. Therefore there is no signficant difference between size of 0 and size of 3, even though the averge house price for homes with garages for three cars is the largest.
...
The R-squared values means that the total variance of house can be explained by this model by 54.68%.
...
If the quadratic effect of the variable *Lot* is included, the new model is shown as follows. The adjusted R-squared is increased by 2.5%, thus we would say that adding the quadratic effect of *Lot* is legitimate.
